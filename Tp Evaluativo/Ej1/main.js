function descuento() {
    ...
    if(Ford==1){
        ...
        document.getElementById("h1_r").textContent = "El precio final sera de: " +Ka+ "\$";
        //Se guardara el precio con el descuento en el h1 gracias al textContent
    }else if(Ford==2){
        const Fiesta = (1950000 * 5) / 100
        //Se realiza el porcentaje y se guarda en una constante
        document.getElementById("h1_r").textContent = "El precio final sera de: " +Fiesta+ "\$";
        //Se guardara el precio con el descuento en el h1 gracias al textContent
    }else{
        const Focus = (2560000 * 10) / 100
        //Se realiza el porcentaje y se guarda en una constante
        document.getElementById("h1_r").textContent = "El precio final sera de: " +Focus+ "\$";
        //Se guardara el precio con el descuento en el h1 gracias al textContent
    }
}
